...
<?php }?>
	...
	foreach ($providers as $provider){
		echo CHtml::link('<img src="'.Yii::app()->baseUrl.'/'.$path.$provider.'.png" alt="'.$provider.'" title="'.$provider.'" />',
		array($url.'/provider/'.$provider),array('id'=>$provider));
		}
	?>
